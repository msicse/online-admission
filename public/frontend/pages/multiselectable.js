...
(function ($) {
	$.fn.multiselectable = function (options) {
		var that = $(this);
		options = $.extend({
			template: '<div class="row"><div class="multiselectable col-md-5">' +
				'<div class="m-selectable-from"><label for="m-selectable"></label>' +
				'<select class=" form-control " multiple="multiple" id="m-selectable"></select>' +
				'</div>' +
				'<div class="m-selectable-controls col-md-2">' +
					'<button class="multis-right"></button>' +
					'<button class="multis-left"></button>' +
				'</div>' +
				'<div class="m-selectable-to col-md-5"><label for="m-selected"></label>' +
				'<select class="form-control" multiple="multiple" id="m-selected"></select>' +
				'</div>' +
			'</div></div>',
